...
- 강조 기법 활용: 중요한 지시사항을 AI가 놓치지 않도록 만들고 싶다면, **대문자(ALL CAPS)**를 사용하거나 문장 끝에 **여러 개의 느낌표(!!!)**를 붙여 강조할 수 있습니다. 이는 AI에게 해당 부분이 특히 중요하다는 강력한 신호를 줍니다.
...
### 초기 프롬프트 작성을 위한 P-T-C-F 원칙

- P - **페르소나** (Persona): AI에게 역할을 부여하세요.
  - AI가 특정 전문가의 관점에서 답변하도록 역할을 지정하면 훨씬 더 깊이 있고 전문적인 결과물을 얻을 수 있습니다.
...
복잡한 문제를 한 번에 풀도록 요구하지 않고, "단계별로 생각해보자 (Let's think step-by-step)" 와 같은 마법의 문장을 추가하여 문제를 분해하고 순차적으로 해결하도록 유도하는 기법입니다. 이는 AI의 추론 과정을 투명하게 만들고, 최종 답변의 정확도를 크게 향상시킵니다.
...
- 단계별 접근: 복잡한 작업은 한 번에 요청하지 말고, 여러 단계로 나누어 질문하며 결과물의 완성도를 높여가세요.

- 관점 제시: 특정 관점에서 문제를 바라보도록 요청하여, 편향되지 않고 다각적인 답변을 유도할 수 있습니다.

- AI에게 질문하게 만들기: 때로는 AI가 더 나은 결과물을 위해 필요한 정보를 역으로 질문하도록 만들 수 있습니다.

- 구체적인 제약 조건 부여: 글자 수, 개수, 포함할/제외할 단어 등을 명시하여 결과물의 형태를 더 정교하게 제어할 수 있습니다.
